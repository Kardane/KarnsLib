...
public class Rotate {
    public static List<Map<String, Double>> ArrayRotate(List<Map<String, Double>> array, Vec2 rotation, Vec3 rotationPos) {
        return ArrayRotate(array, rotation.x, rotation.y, 0, rotationPos);
    }
    public static List<Map<String, Double>> ArrayRotate(List<Map<String, Double>> array, double x, double y, double z, Vec3 rotationPos) {
